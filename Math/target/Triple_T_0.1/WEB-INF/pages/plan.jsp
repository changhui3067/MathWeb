...
<div class="nav_background">
	<div class="nav_div">
		<nav>
			...
			<li class="line"></li>
			<li style='width:121px;' ><a href='gaikuang' class='nav'><span>学会概况</span></a></li>
			<li class="line"></li>
			...
			<li class="line"></li>
			<li style='width:120px;' class='navdown' ><a href='plan'  class='hover-none nav'><span>年度计划</span></a></li>
			</ul>
		</nav>
	</div>
</div>
...
<div class="sidebar inner">
 ...
 <div class="sb_box">
	    <h3 class="title">
						<div class="position">当前位置：<a href="index" title="网站首页">网站首页</a> &gt; <a href="plan" >年度计划</a> > </div>
			<span>年度计划</span>
		</h3>
		<div class="clear"></div>
