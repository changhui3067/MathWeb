...
<div class="sidebar inner">
	...
	<div class="sb_box">
	    <h3 class="title"> 
		<div class="position">当前位置：<a href="index" title="网站首页">网站首页</a> &gt; <a href="huodong" title="学术交流活动">学术交流活动</a> </div>
			<span>学会新闻公告</span>
		</h3>
		<div class="clear"></div>

        <div class="active" id="shownews">
            <h1 class="title">${hd.title}</h1>
			
			<div class="met_hits">
			<span><script language='javascript' ></script></span>
			更新时间：<fmt:formatDate value='${hd.time}' pattern='yyyy-MM-dd HH:mm:ss'/>&nbsp;&nbsp;
