...
<div class="nav_background">
	<div class="nav_div">
		<nav>
			...
			<li class="line"></li>
			<li style='width:121px;' class='navdown' ><a href='meeting'   class='hover-none nav'><span>理事会议</span></a></li>
			<li class="line"></li>
...
<div class="sidebar inner">
 ...
 <div class="sb_box">
	    <h3 class="title">
				<div class="position">当前位置：<a href="index" title="网站首页">网站首页</a> &gt; <a href="meeting" >理事会议</a> > </div>			
			<span>理事会议</span>
		</h3>
		<div class="clear"></div>
