...
<div class="sidebar inner">
	...
	<div class="sb_box">
	    <h3 class="title"> 
		<div class="position">当前位置：<a href="index" title="网站首页">网站首页</a> &gt; <a href="jingsai" title="数学竞赛之窗">数学竞赛之窗</a> </div>
			<span>数学竞赛之窗</span>
		</h3>
		<div class="clear"></div>
        ...
        <div class="active" id="shownews">
			...
			更新时间：<fmt:formatDate value='${js.time}' pattern='yyyy-MM-dd HH:mm:ss'/>&nbsp;&nbsp;
			【<a href="javascript:window.print()">打印此页</a>】
			</div>
			
            <div class="editor">
				<span>${js.content}</span>
				<div class="clear"></div>
			</div>
