...
<div class="nav_background">
	<div class="nav_div">
		<nav>
			...
			<li class="line"></li>
			<li style='width:121px;' class='navdown' ><a href='zhangcheng'  class='hover-none'><span>学会章程</span></a></li>
			<li class="line"></li>
...
<div class="sidebar inner">
 ...
 <div class="sb_box">
	    <h3 class="title">
				<div class="position">当前位置：<a href="index" title="网站首页">网站首页</a> &gt; <a href="zhangcheng" >学会章程</a> > </div>			
			<span>学会章程</span>
		</h3>
		<div class="clear"></div>
        ...
        <div class="editor active" id="showtext">
			<div class = "content">
				<h1 class = "title">江苏省高等学校数学教学研究会章程</h1>
				${intro.introcontent}
			</div>
