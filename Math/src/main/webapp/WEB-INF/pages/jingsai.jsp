...
<div class="sidebar inner">
    ...
    <div class="sb_box">
	    <h3 class="title">
			<div class="position">当前位置：<a href="index" title="网站首页">网站首页</a> &gt; <a href="jingsai">数学竞赛之窗</a></div>
			<span>数学竞赛之窗</span>
		</h3>
		<div class="clear"></div>
        ...
        <div class="active" id="newslist">
			...
			<li class='list top'><span>[2012-07-17]</span><a href='showjingsai' title='请点击这里查看示例竞赛' target='_self'>请点击这里查看示例竞赛</a><img class='listhot' src='img/hot.gif' alt='图片关键词' /></li>

				<c:forEach items="${jsList}" var="Jingsai" begin="${0}" end="${10}">
					<li class='list'>
						<span>[<fmt:formatDate value='${Jingsai.time}' pattern='yyyy-MM-dd'/>]</span>
						<a href='showjingsai.jsp/${Jingsai.id}' title='' target="_self">${Jingsai.title}</a>
