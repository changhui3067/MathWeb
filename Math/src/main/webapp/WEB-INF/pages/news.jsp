...
<div class="sidebar inner">
    ...
    <div class="sb_box">
        ...
        <div class="active" id="newslist">
			...
			<li class='list top'><span>[2012-07-17]</span><a href='shownews.jsp' title='请点击这里查看示例公告' target='_self'>请点击这里查看示例公告</a><img class='listhot' src='img/hot.gif' alt='图片关键词' /></li>
			
			<c:forEach items="${newsList}" var="News" begin="${0}" end="${10}">
				<li class='list'>
					<span>[<fmt:formatDate value='${News.time}' pattern='yyyy-MM-dd'/>]</span>
					<a href='shownews.jsp/${News.id}' title='' target="_self">${News.title}</a>
